...
namespace DPSF.ParticleSystems
{
    ...
    /// </summary>
    class MushroomParticleSystem : DefaultPointSpriteParticleSystem
    {
        ...
        public MushroomParticleSystem(Game cGame) : base(cGame) { }
        ...
        public void LoadParticleSystem()
        {
            ...
            InitialProperties.VelocityMin = new Vector3(3, 0, 3);
            InitialProperties.VelocityMax = new Vector3(-3, -3, -3);
            ...
            InitialProperties.StartSizeMin = 0.4f;
            InitialProperties.StartSizeMax = 0.8f;
            InitialProperties.EndSizeMin = 0.6f;
            InitialProperties.EndSizeMax = 0.6f;
            ...
            Emitter.PositionData.Position = new Vector3(0, 3f, 4f);
        }
    ...
    class MushroomParticleGroup
     {
        public static List<MushroomParticleSystem> ParticleList = new List<MushroomParticleSystem>();
       ...
       static public void NewParticle(Vector3 Position)
        {
            MushroomParticleSystem mcMushroomParticleSystem= new MushroomParticleSystem(null);
            mcMushroomParticleSystem.Pos = Position;
            mcMushroomParticleSystem.timer = 5.0f;
            mcMushroomParticleSystem.AutoInitialize(G, C);
            ParticleList.Add(mcMushroomParticleSystem);
        }

        static public void Update(GameTime gameTime)
         {
             foreach (MushroomParticleSystem item in ParticleList)
             {
